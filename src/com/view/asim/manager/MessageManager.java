...
//		mDBHelper = DataBaseHelper.getInstance(name, Constant.DB_VERSION);
	...
	public void init(DataBaseHelper helper) {
		...
		// 锟剿诧拷锟斤拷锟斤拷斜锟斤拷锟斤拷息锟角凤拷锟接�锟斤拷删锟斤拷锟斤拷锟斤拷锟节的猴拷锟窖碉拷锟斤拷息
	 ...
	 * @param msg
	 * @author xuweinan
	 * @update 2012-5-16 锟斤拷锟斤拷3:23:15
	 */
	...
	/**
	 * 
	 * 锟斤拷锟斤拷锟斤拷某锟剿碉拷锟斤拷锟斤拷锟铰硷拷锟斤拷锟斤拷录
	 * 
	 * [status] NVARCHAR, 
	 * [readStatus] NVARCHAR
	 * [content] NVARCHAR, 
	...
	/**
	 * 
	 * 锟斤拷锟斤拷锟斤拷某锟剿碉拷锟斤拷锟斤拷锟铰硷拷锟斤拷锟�
	 * 
	 * @return
	 * @author xuweinan
	 * @update 2012-7-2 锟斤拷锟斤拷9:31:04
	 */
	...
	/**
	 * 
	 * 锟斤拷取锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷一锟斤拷锟斤拷息锟斤拷未锟斤拷锟斤拷息锟斤拷锟斤拷
	 * 
	 * @return
	 * @author xuweinan
	 */
