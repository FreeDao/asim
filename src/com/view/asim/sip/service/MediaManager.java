...
import com.view.asim.utils.AccessibilityWrapper;
import com.view.asim.utils.Compatibility;
import com.view.asim.utils.Log;
import com.view.asim.utils.Ringer;
import com.view.asim.utils.audio.AudioFocusWrapper;
...
//		}
	...
	public void setSoftwareVolume(){
		...
		if(service != null) {
			final boolean useBT = false; //(bluetoothWrapper != null && bluetoothWrapper.isBluetoothOn());
