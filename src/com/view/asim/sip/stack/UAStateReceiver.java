...
import com.view.asim.sip.service.SipCallSessionImpl;
import com.view.asim.sip.service.SipService;
import com.view.asim.sip.service.SipService.ReturnRunnable;
...
import com.view.asim.utils.Threading;
...
//            notificationManager.showNotificationForVoiceMail(acc, numberOfMessages);
    ...
    public void on_nat_detect(pj_stun_nat_detect_result res) {
        Log.w(THIS_FILE, "NAT TYPE DETECTED !!!" + res.getNat_type_name());
        if (pjService != null) {
