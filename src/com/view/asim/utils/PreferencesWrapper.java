...
public class PreferencesWrapper {
		...
		private static final long serialVersionUID = 1L;
	{
		...
		put(SipConfigManager.LOG_LEVEL, "5");
		...
		private static final long serialVersionUID = 1L;
	{
		...
		put(SipConfigManager.ENABLE_ICE, true);			// Modified
        put(SipConfigManager.ICE_AGGRESSIVE, false);
		put(SipConfigManager.ENABLE_TURN, false);
		put(SipConfigManager.ENABLE_STUN, true);		// Modified
        put(SipConfigManager.ENABLE_STUN2, true);		// Modified
		put(SipConfigManager.ENABLE_QOS, false);
		put(SipConfigManager.USE_COMPACT_FORM, true);	// Modified
		...
		put(SipConfigManager.USE_3G_IN, true);			// Modified
		put(SipConfigManager.USE_3G_OUT, true);			// Modified
		put(SipConfigManager.USE_GPRS_IN, true);		// Modified
		put(SipConfigManager.USE_GPRS_OUT, true);		// Modified
		put(SipConfigManager.USE_EDGE_IN, true);		// Modified
		put(SipConfigManager.USE_EDGE_OUT, true);		// Modified
        put(SipConfigManager.USE_ANYWAY_IN, true);		// Modified
        put(SipConfigManager.USE_ANYWAY_OUT, true);		// Modified
        put(SipConfigManager.USE_ROAMING_IN, true);		// Modified
