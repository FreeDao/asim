 ...
 *
 */
public class QuitGroupChatHandler implements BaseHandler {
	private final static String TAG = "QuitGroupChatHandler";
    ...
    //通过构造函数传递所需的参数
    public QuitGroupChatHandler(GroupUser grp){
    	mGroup = grp;
    ...
    public void execute() {
        ...
        try {        
    		for (String member: mGroup.getGroupUsers()) {
    			...
    			message.setProperty(CtrlMessage.PROP_CTRL_MSGTYPE, CtrlMessage.CTRL_GROUP_QUIT);
