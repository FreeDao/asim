...
//		context.startService(ota);
							...
							public void onCheckResult(boolean needUpgrade, UpgradeRule rule) {
								...
								if(needUpgrade) {
									...
									if(mOTAStatus.trigger.equals(OTAStatusInfo.TRIGGER_MANUAL)) {
										/* FIXME: ��Ҫ�㲥���ؽ��������ģ��
										Looper.prepare();
										Toast.makeText(cntx, "�Ѿ������°汾��Ŷ :)", Toast.LENGTH_SHORT).show();
										Looper.loop();
										*/
									}
									mOTAStatus.init();
	...
	private void showUpgradeNotify() {		
        ...
        builder.setTitle("�汾����");  
        builder.setMessage("�����°汾 " + mOTAStatus.upgradeRule.getTgtVer() + " �Ѿ��������Ƿ��������أ�"); 
        ...
        builder.setPositiveButton(android.R.string.ok,  
                new DialogInterface.OnClickListener() {  
                    public void onClick(DialogInterface dialog, int which) {
                    	...
                    	request.setTitle("���� �°汾 " + mOTAStatus.upgradeRule.getTgtVer() + " ������");
	...
	private void showInstallNotify(Uri uri, String mimeType) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(context);  
        builder.setIcon(android.R.drawable.ic_dialog_info);  
        builder.setTitle("�汾��װ");  
        builder.setMessage("�����°汾 " + mOTAStatus.upgradeRule.getTgtVer() + " ������ɣ��Ƿ��������£�");  
        builder.setPositiveButton(android.R.string.ok,  
                new DialogInterface.OnClickListener() {  
                    public void onClick(DialogInterface dialog, int which) {
